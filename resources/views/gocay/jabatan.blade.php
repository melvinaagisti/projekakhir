    ...
    <div class="grid grid-cols-12 gap-6">
                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3 jabatan-edit" href="javascript:void(0)" data-toggle="modal" 
                                                id="{{ $item->id }}" data-target="#header-footer-modal-preview-edit" data-id="{{ $item->id }}">
                                                    <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit 
                                                </a>
                                                <a class="flex items-center text-theme-6" href="/jabatandelete/{{$item->id}}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');">
        ...
        <div id="header-footer-modal-preview-edit" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <!-- BEGIN: Modal Header -->
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Update Jabatan</h2>
                        <div class="dropdown sm:hidden">
                            <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false">
                                <i data-feather="more-horizontal" class="w-5 h-5 text-gray-600 dark:text-gray-600"></i>
                            </a>
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form method="POST" action="{{ route('jabatanupdate') }}">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            <label for="modal-form-2" class="form-label">Deskripsi</label>
                            <textarea name="deskripsi" id="modal-form-2-edit" class="form-control" cols="30" rows="10" placeholder="jabatannya ngapain"></textarea>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.jabatan-edit').on('click',function() {
                    var id = $(this).attr('data-id');

                    $.ajax({
                        url : "{{route('jabatanedit')}}?id="+id,
                        type: "GET",
                        dataType: "JSON",
