...
@section('head')
    <title>Present & Payroll Gocay</title>
@endsection
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">GOCAY <br> Cafe Resto & Supermarket.</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">Jl. Gelora No.17, Besuki, Kec. Besuki, Kabupaten Situbondo, Jawa Timur 68356, Indonesia</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
